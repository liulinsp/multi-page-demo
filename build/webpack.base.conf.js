...
module.exports = {
  ...
  resolve: {
    ...
    alias: {
      ...
      '@': resolve('src'),
      'default-bridge': process.env.NODE_ENV === 'production'
        ? resolve('src/plugins/jsbridge-plugin/default-bridge-pro.js')
        : resolve('src/plugins/jsbridge-plugin/default-bridge-dev.js')
    }
  },
  module: {
    rules: [
